...
Committed 5ef4dc5, pushed. CI run 30356XXXXX: GREEN (backend-build-test + security both passing). Sprint 2 Epic 1 (Identity & Access, full-stack) is now CLOSED: backend + frontend + CI green + e2e recorded + coverage gates cleared + pushed.
